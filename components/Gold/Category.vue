        ...
        <v-card-title style="background-color: #e7e6e6">
          <div style="display: flex; width: 100%; align-items: center; justify-content: center;">
            <div style="display: flex; align-items: center">
              <v-icon large color="grey">mdi-package-variant-plus</v-icon>
              <h4 class="mx-2">ເພີ່ມປະເພດຮູບປະພັນ</h4>
            </div>
            <v-spacer></v-spacer>
          ...
          <div style="display: flex;" class="pb-6 mt-4">
            <div style="display: flex; align-items: center; justify-content: center; min-width: 100%;">
              <v-text-field
                ...
                outlined
              ></v-text-field>
              <v-btn :disable="name" @click="onAdd()" class="mx-1" style="height: 40px;" color="primary">ເພີ່ມ</v-btn>
            </div>
          </div>
          <v-row>
            <v-col cols="12">
